...
public class DataProviderClients {
    ...
    public Object[][] dataClients(){
        ...
        Object[][] data = excelHelpers.getDataHashTable(SystemHelpers.getCurrentDir() + ConfigData.LOGIN_HRM_EXCEL, "Clients", 5, 7);
        return data;
    }

    @DataProvider(name = "data_delete_clients", parallel = false)
